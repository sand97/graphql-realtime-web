...
import {Autocomplete, AutocompleteFreeSoloValueMapping, AutocompleteInputChangeReason, TextField} from "@mui/material";
            ...
            <Autocomplete
                ...
                renderInput={(params) =>
                    <TextField
                        ...
                        helperText={(meta.touched && meta.error) ?? (props.multiple && props.freeSolo ? t('use_enter_to_add_item') : null)}
                    />}
