...
const UpdateProfile = (props: Props) => {
    ...
    return (
        <Card elevation={2} >
            <Typography sx={{ p: 2}} variant={'h6'}> {t('update_profile_title')}</Typography>
            <Box  mb={2}>
                <Divider/>
            </Box>
            <Box p={2}>
                    ...
                    {({
                        ...
                        <Form onSubmit={e => {
                            ...
                            <Grid container spacing={2}>
                                ...
                                <FormikTextField xs={12}
                                                 disabled
                                                 startIcon={`${auth?.user?.country_code}`}
                                                 placeholder={t('login_page.form_phone')}
                                                 name={'phone'}/>
